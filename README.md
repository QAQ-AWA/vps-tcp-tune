...
- **IPv4优先**：选项 **9**（未安装）/ **10**（已安装）
- **IPv6优先**：选项 **10**（未安装）/ **11**（已安装）
...
- **查看配置**：选项 **12**（未安装）/ **13**（已安装）
- **IPv6出站**：选项 **13**（未安装）/ **14**（已安装）
- **恢复默认**：选项 **14**（未安装）/ **15**（已安装）
